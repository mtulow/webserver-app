...
session.add_all([
    ...
    MenuItem(name="Peking Duck", description=" A famous duck dish from Beijing[1] that has been prepared since the imperial era. The meat is prized for its thin, crisp skin, with authentic versions of the dish serving mostly the skin and little meat, sliced in front of the diners by the cook",\
...
session.add_all([
    ...
    MenuItem(name="Gyoza", description="light seasoning of Japanese gyoza with salt and soy sauce, and in a thin gyoza wrapper",\
...
session.add_all([
    ...
    MenuItem(name="Cauliflower Manchurian", description="Golden fried cauliflower florets in a midly spiced soya,garlic sauce cooked with fresh cilantro, celery, chilies,ginger & green onions",\
...
session.add_all([
    ...
    MenuItem(name="Choc Full O\' Mint (Smitten\'s Fresh Mint Chip ice cream)", description="Milk, cream, salt, ..., Liquid cream, and fresh mint",\
...
session.add_all([
    MenuItem(name="Chicken Fried Steak", description="Fresh battered sirloin steak fried with butter",\
            price="$8.99", course="Entree", restaurant=restaurant1),
    ...
    MenuItem(name="Tandoori Chicken", description="Chicken marinated in yoghurt and seasoned with a spicy mix(chilli, tamarind among others) and slow cooked in a cylindrical clay or metal oven which gets its heat from burning charcoal.",\
            price="$8.95", course="Entree", restaurant=restaurant1),
    MenuItem(name="Veggie Burger", description="Juicy grilled veggie patty with tomato mayo and lettuce",\
            price="$9.50", course="Entree", restaurant=restaurant1),
    MenuItem(name="spinach ice cream", description="vanilla ice cream made with organic spinach leaves",\
...
session.add_all([
    ...
    MenuItem(name="Cachapa", description="Golden brown, corn-based Venezuelan pancake; usually stuffed with queso telita or queso de mano, and possibly lechon. ",\
            price="$7.99", course="Entree", restaurant=restaurant1),
])
session.commit()
